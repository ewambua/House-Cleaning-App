    ...
    <div>
      <form action="" className="form_main"> {/* Use className instead of class */}
        ...
        <div className="inputContainer"> {/* Use className instead of class */}
          ...
          <input type="text" className="inputField" id="username" placeholder="Username" /> {/* Use className instead of class */}
        </div>
        ...
        <div className="inputContainer"> {/* Use className instead of class */}
          ...
          <input type="password" className="inputField" id="password" placeholder="Password" /> {/* Use className instead of class */}
        </div>

        <button id="button">Submit</button>
        <a className="forgotLink" href="#">Forgot your password?</a> {/* Use className instead of class */}
      </form>
    </div>
  );
};
