...
const Login = () => {
  ...
  const [showSuccess, setShowSuccess] = useState(false); // State to control success message visibilit
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Handle login error
        swal("Oops!", "Something went wrong, make sure to enter correct email and password!", "error");          console.log('Signup failed. Error:', errorData.errors);
